...
>
    ...
    <Button
    size="sm"
    className="bg-[#00875A] hover:bg-[#007A51] text-white text-base sm:text-lg md:text-xl"
  >
        Learn More
    ...
    size="sm"
    variant="outline"
    className="bg-transparent border-white text-white hover:bg-white/10 text-base sm:text-lg md:text-xl"
  >
    Get Involved
  </Button>
          ...
          {images.map((_, index) => (
            ...
            >
              ...
              <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                <div className="bg-white text-black text-xs px-2 py-1 rounded whitespace-nowrap">
                  Slide {index + 1}
                </div>
